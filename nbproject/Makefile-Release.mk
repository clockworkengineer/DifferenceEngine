...
${OBJECTDIR}/Actions/CopyFile.o: Actions/CopyFile.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/CopyFile.o Actions/CopyFile.cpp

${OBJECTDIR}/Actions/EmailFile.o: Actions/EmailFile.cpp
	${MKDIR} -p ${OBJECTDIR}/Actions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/EmailFile.o Actions/EmailFile.cpp

${OBJECTDIR}/Actions/ImportCSVFile.o: Actions/ImportCSVFile.cpp
	${MKDIR} -p ${OBJECTDIR}/Actions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/ImportCSVFile.o Actions/ImportCSVFile.cpp

${OBJECTDIR}/Actions/RunCommand.o: Actions/RunCommand.cpp
	${MKDIR} -p ${OBJECTDIR}/Actions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/RunCommand.o Actions/RunCommand.cpp

${OBJECTDIR}/Actions/VideoConversion.o: Actions/VideoConversion.cpp
	${MKDIR} -p ${OBJECTDIR}/Actions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/VideoConversion.o Actions/VideoConversion.cpp

${OBJECTDIR}/Actions/ZipFile.o: Actions/ZipFile.cpp
	${MKDIR} -p ${OBJECTDIR}/Actions
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/ZipFile.o Actions/ZipFile.cpp

${OBJECTDIR}/FPE.o: FPE.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FPE.o FPE.cpp

${OBJECTDIR}/FPE_ProcCmdLine.o: FPE_ProcCmdLine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FPE_ProcCmdLine.o FPE_ProcCmdLine.cpp

${OBJECTDIR}/FPE_TaskActions.o: FPE_TaskActions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FPE_TaskActions.o FPE_TaskActions.cpp
...
${TESTDIR}/tests/ProcCmdLineTests.o: tests/ProcCmdLineTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ProcCmdLineTests.o tests/ProcCmdLineTests.cpp
...
${OBJECTDIR}/Actions/CopyFile_nomain.o: ${OBJECTDIR}/Actions/CopyFile.o Actions/CopyFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/CopyFile_nomain.o Actions/CopyFile.cpp;\
	else  \
...
${OBJECTDIR}/Actions/EmailFile_nomain.o: ${OBJECTDIR}/Actions/EmailFile.o Actions/EmailFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/EmailFile_nomain.o Actions/EmailFile.cpp;\
	else  \
...
${OBJECTDIR}/Actions/ImportCSVFile_nomain.o: ${OBJECTDIR}/Actions/ImportCSVFile.o Actions/ImportCSVFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/ImportCSVFile_nomain.o Actions/ImportCSVFile.cpp;\
	else  \
...
${OBJECTDIR}/Actions/RunCommand_nomain.o: ${OBJECTDIR}/Actions/RunCommand.o Actions/RunCommand.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/RunCommand_nomain.o Actions/RunCommand.cpp;\
	else  \
...
${OBJECTDIR}/Actions/VideoConversion_nomain.o: ${OBJECTDIR}/Actions/VideoConversion.o Actions/VideoConversion.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/VideoConversion_nomain.o Actions/VideoConversion.cpp;\
	else  \
...
${OBJECTDIR}/Actions/ZipFile_nomain.o: ${OBJECTDIR}/Actions/ZipFile.o Actions/ZipFile.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Actions/ZipFile_nomain.o Actions/ZipFile.cpp;\
	else  \
...
${OBJECTDIR}/FPE_nomain.o: ${OBJECTDIR}/FPE.o FPE.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FPE_nomain.o FPE.cpp;\
	else  \
...
${OBJECTDIR}/FPE_ProcCmdLine_nomain.o: ${OBJECTDIR}/FPE_ProcCmdLine.o FPE_ProcCmdLine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FPE_ProcCmdLine_nomain.o FPE_ProcCmdLine.cpp;\
	else  \
...
${OBJECTDIR}/FPE_TaskActions_nomain.o: ${OBJECTDIR}/FPE_TaskActions.o FPE_TaskActions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I../Antik/include -I../Antik/classes/implementation -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FPE_TaskActions_nomain.o FPE_TaskActions.cpp;\
	else  \
